...
/**
 * A unit test class for implementations of the SimpleSet ADT. This is a set of
 * black box tests that should work for any implementation of this interface.
 *
 * @author mvail
 */
public class SetTester {
    ...
    /**
     * Run tests to confirm required functionality from set constructors and
     * methods
     */
    ...
    // ///////////////////////////////////////
    /**
     * Returns a SimpleSet for the "new empty set" scenario. Scenario: no set ->
     * constructor -> [ ]
     *
    ...
    /**
     * Runs remove() method on given set and checks result against
     * expectedResult
     *
     * @param set a set already prepared for a given change scenario
    ...
    /**
     * Runs contains() method on a given set and element and checks result
    ...
    /**
     * Runs isEmpty() method on a given set and checks result against
     * expectedResult
     *
     * @param set a set already prepared for a given change scenario
     * @param expectedResult
    ...
    /**
     * Runs size() method on a given set and checks result against
     * expectedResult
     *
     * @param set a set already prepared for a given change scenario
     * @param expectedSize
    ...
    /**
     * Runs toString() method on given set and attempts to confirm non-default
